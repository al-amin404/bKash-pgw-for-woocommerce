			...
			foreach ( $agreements as $i => $agreement ) {
				...
				<tr>
					<td>
						<label for="
						<?php
						esc_html_e( $agreement->agreement_token ?? '', 'bkash-pgw-for-woocommerce' );
						?>
						">
							<input
								id="
								<?php
								esc_html_e( $agreementToken, 'bkash-pgw-for-woocommerce' );
								?>
								"
								type="radio"
								name="agreement_id"
							...
							/>
							<?php
							esc_html_e( $agreement->phone ?? '', 'bkash-pgw-for-woocommerce' );
							?>
						</label>
					</td>
					<td>
