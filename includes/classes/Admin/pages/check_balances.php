...
if ( isset( $balances ) && is_string( $balances ) ) { ?>
	<div id="message" class="woocommerce-message bKash-hero-div bKash-error-div"><p>
			<?php esc_html_e( ( $balances ?? '' ), 'bkash-pgw-for-woocommerce' ); ?>
			</p></div>
	<?php
	...
	foreach ( $balances['organizationBalance'] as $balance ) {
		...
		<p class="main"><strong>
		<?php
				esc_html_e( $balance['accountTypeName'] ?? '', 'bkash-pgw-for-woocommerce' );
		?>
				</strong></p>
		<hr>
		<p>Current Balance:<b>
		...
		<ul>
			...
			<?php
					esc_html_e( $balance['accountStatus'] ?? '', 'bkash-pgw-for-woocommerce' );
			?>
					</strong></li>
			<li>Account Name<strong>
			<?php
					esc_html_e( $balance['accountHolderName'] ?? '', 'bkash-pgw-for-woocommerce' );
			?>
					</strong></li>
			<li>Last updated<strong>
			<?php
					esc_html_e( $balance['updateTime'] ?? '', 'bkash-pgw-for-woocommerce' );
			?>
					</strong></li>
		</ul>
		<p>
