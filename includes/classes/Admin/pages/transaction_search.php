...
<h1>
<?php
	esc_attr_e( get_admin_page_title(), 'bkash-pgw-for-woocommerce' );
?>
	</h1>
<br>
<form action="#" method="post">
	<label for="trxid" class="form-label">Transaction ID</label>
	<input name="trxid" type="text" id="trxid" placeholder="Transaction ID" class="form-text-input" value="<?php esc_attr_e( $trx_id ?? '', 'bkash-pgw-for-woocommerce' ); ?>">
...
if ( isset( $trx ) && is_string( $trx ) ) {
	...
	<div class="gateway-banner bKash-hero-div bKash-success">
		...
		<p class="main">
			...
			<?php
				esc_html_e( $trx['trxID'] ?? '', 'bkash-pgw-for-woocommerce' );
			?>
				</strong>
		</p>
		<hr>
		<p>Sender: <b>
		<?php
				esc_html_e( $trx['customerMsisdn'] ?? '', 'bkash-pgw-for-woocommerce' );
		?>
				</b></p>
		<p>
			Amount:
		...
		<ul>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['transactionType'] ?? '', 'bkash-pgw-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['organizationShortCode'] ?? '', 'bkash-pgw-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['initiationTime'] ?? '', 'bkash-pgw-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
